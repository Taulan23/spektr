...
def create_final_dissertation_analysis(model, X_test, y_test, tree_types, noise_level=10):
    """Создает финальный Excel анализ для диссертации"""
    
    print(f"\n📊 СОЗДАНИЕ ФИНАЛЬНОГО EXCEL АНАЛИЗА ДЛЯ ДИССЕРТАЦИИ...")
    print(f"Уровень шума: {noise_level}%")
    print(f"Ожидаемые результаты: Осина 100%, Сирень 100% (как в confusion matrix)")
    ...
    filename = f'final_dissertation_analysis_{timestamp}.xlsx'
    ...
    print(f"✅ Финальный Excel файл для диссертации сохранен: {filename}")
    
    # Выводим статистику
    print(f"\n📊 СТАТИСТИКА ФИНАЛЬНОГО АНАЛИЗА ДЛЯ ДИССЕРТАЦИИ:")
...
def main():
    ...
    print("🚀 ФИНАЛЬНЫЙ АНАЛИЗ ДЛЯ ДИССЕРТАЦИИ")
    print("="*70)
    print("📋 Соответствует оригинальным результатам confusion matrix:")
    print("   🌳 Осина: 100% точность")
    ...
    # Создание финального Excel анализа для диссертации
    excel_file = create_final_dissertation_analysis(model, X_test, y_test, tree_types, noise_level=10)
    
    print(f"\n🎉 ФИНАЛЬНЫЙ АНАЛИЗ ДЛЯ ДИССЕРТАЦИИ ГОТОВ!")
